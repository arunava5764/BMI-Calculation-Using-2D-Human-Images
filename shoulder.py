...
image=cv2.imread('ANKITA_FRONT_EDIT.jpg',0)
start1=0
start2=0
end1=0
end2=0
...
xaxis=np.arange(start1,newend+2).reshape(((end1-start1)//4)+2)
distances=np.array(distances).reshape(((end1-start1)//4)+2)
# =============================================================================
# yaxisleft=np.array(yaxisleft).reshape(((end1-start1)//4)+2)
# yaxisright=np.array(yaxisright).reshape(((end1-start1)//4)+2)
# =============================================================================
#print(distances)
xreq=xaxis[len(yaxisleft)//2:]
yreq=distances[len(distances)//2:]
STRAND=18
firstslope=[]
last=None
# =============================================================================
